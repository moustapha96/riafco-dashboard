...
export default function CryptoChart(){
    ...
    return(
        <div className="grid xl:grid-cols-6 md:grid-cols-3 grid-cols-1 mt-6 gap-6">
            <div className="relative overflow-hidden p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                <div className="relative flex justify-between items-center mb-8 z-1">
                    <div className="flex items-center">
                        <img src={coin1} className="size-11 rounded-full shadow-sm dark:shadow-gray-700 p-1.5 me-1" alt=""/>
            ...
            <div className="relative overflow-hidden p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                <div className="relative flex justify-between items-center mb-8 z-1">
                    <div className="flex items-center">
                        <img src={coin2} className="size-11 rounded-full shadow-sm dark:shadow-gray-700 p-1.5 me-1" alt=""/>
            ...
            <div className="relative overflow-hidden p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                <div className="relative flex justify-between items-center mb-8 z-1">
                    <div className="flex items-center">
                        <img src={coin3} className="size-11 rounded-full shadow-sm dark:shadow-gray-700 p-1.5 me-1" alt=""/>
            ...
            <div className="relative overflow-hidden p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                <div className="relative flex justify-between items-center mb-8 z-1">
                    <div className="flex items-center">
                        <img src={coin4} className="size-11 rounded-full shadow-sm dark:shadow-gray-700 p-1.5 me-1" alt=""/>
            ...
            <div className="relative overflow-hidden p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                <div className="relative flex justify-between items-center mb-8 z-1">
                    <div className="flex items-center">
                        <img src={coin5} className="size-11 rounded-full shadow-sm dark:shadow-gray-700 p-1.5 me-1" alt=""/>
            ...
            <div className="relative overflow-hidden p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                <div className="relative flex justify-between items-center mb-8 z-1">
                    <div className="flex items-center">
                        <img src={coin6} className="size-11 rounded-full shadow-sm dark:shadow-gray-700 p-1.5 me-1" alt=""/>
