                            ...
                            <div className="grid grid-cols-12 gap-3">
                                ...
                                <div className="col-span-12">
                                    ...
                                    <div className="relative mt-2">
                                        <Link to="" className="absolute top-0.5 end-0.5 size-9 text-xl bg-gray-100 dark:bg-slate-800 inline-flex justify-center items-center text-dark dark:text-white rounded" id="QUcode"><i className="uil uil-copy"></i></Link>
                                        <input type="text" className="form-input pe-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-[var(--riafco-blue)] dark:border-gray-800 dark:focus:border-[var(--riafco-blue)] focus:ring-0" value="c12b001a15f9bd46ef1c6551386c" required/>
                                    </div>
                                </div>
                            </div>
                        </form>
