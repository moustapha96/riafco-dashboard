        ...
        <div className="xl:col-span-3 lg:col-span-6">
            <div className="rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                <div className="p-6 flex items-center justify-between border-b border-gray-100 dark:border-gray-800">
                    ...
                    <Link to="" className="text-slate-400 hover:text-[var(--riafco-blue)] dark:text-white/70 dark:hover:text-white text-[20px]"><i className="mdi mdi-swap-vertical"></i></Link>
                </div>
