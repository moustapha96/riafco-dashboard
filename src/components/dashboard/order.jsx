                                        ...
                                        return(
                                            <tr key={index}>
                                                ...
                                                <td className="text-end border-t border-gray-100 dark:border-gray-800 p-4">
                                                    ...
                                                    {item.status === 'New Order' ?   <span className="bg-[var(--riafco-blue)]/10 dark:bg-[var(--riafco-blue)]/20 border border-[var(--riafco-blue)]/10 dark:border-[var(--riafco-blue)]/20 text-[var(--riafco-blue)] text-[12px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">{item.status}</span> : ''}
