        ...
        <div className="xl:col-span-4 lg:col-span-6">
            <div className="rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                <div className="flex justify-between items-center border-b border-gray-100 dark:border-gray-800 p-4">
                    <div className="flex">
                        <img src={client1} className="size-11 rounded-full shadow-sm dark:shadow-gray-700" alt=""/>
                    ...
                    <div className="dropdown relative">
                        ...
                        <div className={`dropdown-menu absolute end-0 m-0 mt-4 z-10 w-44 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 ${manu ? '' : 'hidden'}`}>
                            <ul className="py-2 text-start">
                                <li className="ml-0">
                                    <Link to="" className="block font-medium py-1 px-4 text-slate-400 dark:text-white/70 hover:text-slate-900 dark:hover:text-white"><i className="mdi mdi-account-outline"></i> Profile</Link>
                                </li>
                                <li className="ml-0">
                                    <Link to="" className="block font-medium py-1 px-4 text-slate-400 dark:text-white/70 hover:text-slate-900 dark:hover:text-white"><i className="mdi mdi-cog-outline"></i> Profile Settings</Link>
                                </li>
                                <li className="ml-0">
                                    <Link to="" className="block font-medium py-1 px-4 text-slate-400 dark:text-white/70 hover:text-slate-900 dark:hover:text-white"><i className="mdi mdi-trash-can-outline"></i> Delete</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div className="inline-block">
                                <div className="flex mb-3">
                                    <div className="relative order-2">
                                        <img src={client2} className="size-9 min-w-[36px] rounded-full shadow-sm dark:shadow-gray-700" alt=""/>
                        ...
                        <li className="text-end">
                            <div className="inline-block">
                                <div className="flex mb-3">
                                    ...
                                    <div className="me-2 max-w-lg">
                                        <p className="bg-white dark:bg-slate-900 text-slate-400 text-sm shadow-sm dark:shadow-gray-700 px-3 py-2 rounded mb-1">Sure please check below link to find more useful information <Link href="https://shreethemes.in/techwind/" target="_blank" className="text-[var(--riafco-blue)]">https://shreethemes.in/techwind/</Link></p>
                ...
                <div className="p-2 border-t border-gray-100 dark:border-gray-800">
                    <div className="flex ">
                        ...
                        <div className="min-w-[125px] text-end space-x-1">
                            <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[16px] text-center bg-[var(--riafco-blue)] hover:bg-indigo-700 border-[var(--riafco-blue)] hover:border-indigo-700 text-white rounded-md"><i className="mdi mdi-send"></i></Link>
                            <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[16px] text-center bg-[var(--riafco-blue)] hover:bg-indigo-700 border-[var(--riafco-blue)] hover:border-indigo-700 text-white rounded-md"><i className="mdi mdi-emoticon-happy-outline"></i></Link>
                            <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[16px] text-center bg-[var(--riafco-blue)] hover:bg-indigo-700 border-[var(--riafco-blue)] hover:border-indigo-700 text-white rounded-md"><i className="mdi mdi-paperclip"></i></Link>
                        </div>
                    </div>
                </div>
            </div>
