            ...
            <div className="layout-specing">
                <div className="md:flex justify-between items-center">
                    ...
                    <ul className="tracking-[0.5px] inline-flex items-center sm:mt-0 mt-3">
                        ...
                        <li className="inline-block capitalize text-[14px] font-bold text-[var(--riafco-blue)] dark:text-white" aria-current="page">Invoice</li>
                    </ul>
                </div>
                    ...
                    <div className="md:flex justify-center">
                        <div className="lg:w-4/5 w-full">
                            <div className="p-6 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                                    ...
                                    <div className="md:flex justify-between">
                                        <div>
                                            ...
                                            <div className="flex mt-4">
                                                <Icon.Link className="size-4 me-3 mt-1"/>
                                                <Link to="https://1.envato.market/techwind-react" target="_blank" className="text-[var(--riafco-blue)] dark:text-white font-medium">https://1.envato.market/techwind-react</Link>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-6 md:mt-0 md:w-56">
                                            ...
                                            <ul className="list-none">
                                                <li className="flex mt-3">
                                                    <Icon.MapPin className="size-4 me-3 mt-1"/>
                                ...
                                <div className="relative overflow-x-auto shadow-sm dark:shadow-gray-700 rounded-md mt-6">
                                    ...
                                    <div className="md:flex justify-between">
                                        ...
                                        <div className="mt-4 md:mt-0">
                                            <div className="text-slate-400 text-center md:text-end">
                                                <h6 className="mb-0"><Link to="/page-terms" target="_blank" className="text-[var(--riafco-blue)]">Terms & Conditions</Link></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
