                        ...
                        <div className="grid grid-cols-1 gap-6">
                            <div className="relative rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                                <div className="p-6 md:flex justify-between items-center border-b border-gray-100 dark:border-gray-700">
                                    ...
                                    <Link to="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[var(--riafco-blue)] hover:bg-indigo-700 border-[var(--riafco-blue)] hover:border-indigo-700 text-white rounded-md">Switch to Annual Plan</Link>
                                </div>
                                        ...
                                        {paymentData.map((item,index)=>{
                                            return(
                                                <li className="flex justify-between items-center py-6" key={index}>
                                                    ...
                                                    <div>
                                                        <Link to="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center bg-red-600/5 hover:bg-red-600 border-red-600/10 hover:border-red-600 text-red-600 hover:text-white rounded-full"><Icon.Trash2 className="size-4"/></Link>
                                                    </div>
                                                </li>
                                            )
                                        })}
                                        <li className="py-6 border-t border-gray-100 dark:border-gray-700">
                                            <Link to="#!" data-modal-toggle="paymentMethod" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[var(--riafco-blue)] hover:bg-indigo-700 border-[var(--riafco-blue)] hover:border-indigo-700 text-white rounded-md">Add Payment Method</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
